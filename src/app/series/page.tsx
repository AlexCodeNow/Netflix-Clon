...
import { Genre, TVShow, tmdbService } from '@/src/services/tmdb';
import TVShowCard from '@/src/components/tv/TVShowCard';
...
export default function SeriesPage() {
  ...
  useEffect(() => {
    const loadShows = async () => {
      ...
      setIsLoading(true);
      try {
        const response = await tmdbService.getTVShowsByGenre(selectedGenre.id);
